...
//console.log(cards);
//colsole.log(cards ostanceof Array)
...
let gameResult=0;//pozniej sprawdzenie tego równiania to if )gamePairs==gameResult) end
...
/*Mini gra - dwa klikniecia*/
    ...
    /*console.log("click")*/                                                                         activeCard.classList.remove("hidden");
...
const init = function ()
{
    cards.forEach(card=>
    {
        ...
        cardColors.splice(position, 1);//splice - polecenie usuwa elememt tablicy
        })
